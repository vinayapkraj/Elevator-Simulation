import { Component, ElementRef, Renderer, ContentChildren, Input } from '@angular/core';
...
export { Ng4DropdownMenu };
Ng4DropdownMenu.decorators = [
    { type: Component, args: [{
...
Ng4DropdownMenu.ctorParameters = function () { return [
    { type: DropdownStateService, },
    { type: ElementRef, },
    { type: Renderer, },
]; };
Ng4DropdownMenu.propDecorators = {
    'width': [{ type: Input },],
    'focusFirstElement': [{ type: Input },],
    'offset': [{ type: Input },],
    'appendToBody': [{ type: Input },],
    'items': [{ type: ContentChildren, args: [Ng4MenuItem,] },],
};
